...
EMAIL_HOST_USER = 'psychometric254@gmail.com'  # Replace with your email address
EMAIL_HOST_PASSWORD = 'zorlaankundgmeia'  # Replace with your email password
EMAIL_USE_TLS = True  # Set to True if your server uses TLS encryption
